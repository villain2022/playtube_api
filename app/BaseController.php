...
abstract class BaseController
{
     ...
     * @return void
     */
    protected function success($msg = '', string $url = null, int $wait = 3, $data = '')
    {
     ...
     * @return void
     */
    protected function error($msg = '', string $url = null, int $wait = 3, $data = '')
    {
        if (is_null($url)) {
     ...
     */
    protected function log($msg, $file_name){
        $log_file=fopen("./log/".$file_name,"a+");
